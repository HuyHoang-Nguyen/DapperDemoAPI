...
namespace DapperDemoAPI.Repositories
{
    public class DepartmentRepository : BaseRepository, IDepartmentRepository
    {
        ...
        {
            using var connection = CreateConnection(); return await connection.QueryFirstOrDefaultAsync<Department>("select * from Departments where Id = @Id and IsDeleted = 0", new { Id = id });
        }
